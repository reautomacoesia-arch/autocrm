...
import { Download, File, FileSpreadsheet, FileText, ImageIcon, Loader2, Pencil, Trash2, Upload, X, Check } from 'lucide-react'
...
export default function DocumentsTab({ clientId }: { clientId: string }) {
  ...
  // editingId: qual doc está com o campo de descrição aberto
  ...
  // Foca o input de descrição quando abre
  useEffect(() => {
    if (editingId) {
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Mostra descrição se existir e não estiver editando */}
              ...
              {/* Campo de observação (expande quando editando) */}
              {editingId === doc.id && (
